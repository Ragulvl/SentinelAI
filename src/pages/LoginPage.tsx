    ...
    <div className="min-h-screen flex" style={{ background: "hsl(var(--background))" }}>
      ...
      >
        ...
        <div className="relative z-10 text-center px-12 max-w-md">
          ...
          >
            The enterprise AI security platform that scans, detects, and fixes vulnerabilities — automatically.
          </motion.p>
      ...
      >
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-xl text-sm cursor-not-allowed"
              style={{
                background: "hsl(var(--muted) / 0.5)",
                border: "1px solid hsl(var(--border))",
            ...
            >
              ...
              <span className="ml-auto text-[10px] font-mono opacity-50">soon</span>
            </button>
          </div>
