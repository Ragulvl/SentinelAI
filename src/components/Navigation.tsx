...
export const Navigation = () => {
  ...
  return (
    <header className="border-b border-border/50 px-6 py-1.5 backdrop-blur-sm bg-black/50 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          >
            <img src={logo} alt="SentinelAI logo" className="h-8 w-auto" />
            <span
