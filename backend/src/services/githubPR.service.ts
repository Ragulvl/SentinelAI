...
export class GitHubPRService {
  ...
  private static generatePRDescription(vulnerabilities: IVulnerability[]): string {
    ...
    description += `This PR addresses **${vulnerabilities.length} security vulnerabilities** detected by SentinelAI.\n\n`;
    ...
    description += `---\n`;
    description += `🤖 Generated by [SentinelAI](https://github.com/sentinelai) - AI-Powered Security Scanner\n`;
  ...
  static async addLabels(
    ...
    try {
      await axios.post(
        ...
        {
          labels: ['security', 'automated', 'sentinelai'],
        },
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
